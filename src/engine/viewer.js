...
export async function openEngine({opener=document.activeElement}={}){
 ...
 function reveal(){openStart=openAmount;speedStart=speed;phase='reveal';phaseTime=0;interacted=false;controls.autoRotate=false;caption('02 / INSPEÇÃO','CONJUNTO<br>ABERTO','O virabrequim para. Bloco, admissão, MGU-K de 350 kW e turbo se afastam. Sem MGU-H (regulamento 2026).');if(reduced){openAmount=1;speed=0;phase='open';}}
 ...
 function reset(){openStart=openAmount;phase='return';phaseTime=0;interacted=false;caption('01 / CONJUNTO MONTADO','V6 TURBO<br>+ MGU-K','ICE ~400 kW e MGU-K 350 kW. Sem MGU-H. Trompetas fixas.');if(reduced){openAmount=0;speed=0;phase='assembled';}}
