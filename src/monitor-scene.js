...
export function monitorMarkup(){return `<section id="analise-no-box" class="monitor-scene" aria-labelledby="monitor-scene-title"><div class="monitor-scene-pin"><div class="monitor-scene-heading"><p>CRÍTICA / EXEMPLO NO BOX</p><h2 id="monitor-scene-title">O crítico encontra a falha</h2></div><div class="monitor-reading-text"><p>O teste comparou dois formulários, com 50 pedidos por versão: as medianas foram de 12 e 9 minutos.</p><p>O formulário e a equipe mudaram juntos. O teste não isolou a causa da diferença.</p><p>Podemos comunicar a redução observada. Atribuir o ganho ao formulário vai além do que o registro sustenta.</p></div><nav class="monitor-scene-controls" aria-label="Leitura do monitor"><button type="button" data-monitor-prev>← Voltar</button><span id="monitor-page" aria-live="polite">1 / 3 · Observação</span><button type="button" data-monitor-next>Próxima →</button></nav></div></section>`;}
